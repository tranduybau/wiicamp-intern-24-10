  ...
  return (
    <div className={styles.footer}>
      <div className={styles.footer__tabs}>
        <div className={styles.tabs__list__one}>
          <div className={styles.tabs__item__one}>
            <div className={styles.tabs__item__logo}>
              <p className={styles.tabs__item__logo__text}>Exclusive</p>
            </div>
            <p className={styles.tabs__item__Sub}>Subscribe</p>
            <p className={styles.tabs__item__text}>
              Get 10% off your first order
            </p>
          </div>
          <div className={styles.tabs__input}>
            <div className={styles.tabs__input__email}>Enter your email</div>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              className={styles.tabs__input__icon}
            >
              <path
        ...
        <div className={styles.tabs__list__two}>
          <p className={styles.tabs__item__Sup}>Support</p>
          <div className={styles.tabs__item__two}>
            <p className={styles.tabs__item__two__text}>
              111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.
            </p>
            <p className={styles.tabs__item__two__text}>exclusive@gmail.com</p>
            <p className={styles.tabs__item__two__text}>+88015-88888-9999</p>
          </div>
        </div>
        <div className={styles.tabs__list__three}>
          <p className={styles.tabs__item__Acc}>Account</p>
          <div className={styles.tabs__item__three}>
            <p className={styles.tabs__item__text}>My Account </p>
            <p className={styles.tabs__item__text}>Login / Register </p>
            <p className={styles.tabs__item__text}>Cart </p>
            <p className={styles.tabs__item__text}>Wishlist </p>
            <p className={styles.tabs__item__text}>Shop </p>
          </div>
        </div>
        <div className={styles.tabs__list__four}>
          <p className={styles.tabs__item__Quick}>Quick Link</p>
          <div className={styles.tabs__item__four}>
            <p className={styles.tabs__item__text}>Privacy Policy </p>
            <p className={styles.tabs__item__text}>Terms Of Use </p>
            <p className={styles.tabs__item__text}>FAQ</p>
            <p className={styles.tabs__item__text}>Contact </p>
          </div>
        </div>
        <div className={styles.tabs__list__five}>
          <p className={styles.tabs__item__Download}>Download App</p>
          <div className={styles.tabs__item__five}>
            <p className={styles.tabs__item__text__Save}>
              Save $3 with App New User Only
            </p>
            <div className={styles.tabs__contact}>
              {/* <Image
                src="/img/qrcode.jpg"
                alt="QR code"
                width={76}
            ...
            <div className={styles.tabs__link}>
              <a href="https://www.facebook.com/hoangvinh02">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  fill="none"
                  className={styles.tabs__facebook}
                >
                  <path
              ...
              <a href="https://twitter.com/">
                <svg
                  ...
                  viewBox="0 0 23 24"
                  fill="none"
                  className={styles.tabs__twitter}
                >
                  <path
              ...
              <a href="https://www.instagram.com/">
                <svg
                  ...
                  viewBox="0 0 20 20"
                  fill="none"
                  className={styles.tabs__instagram}
                >
                  <path
      ...
      <div className={styles.text}>111</div>
    </div>
  );
}
