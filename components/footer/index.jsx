...
function Footer() {
  return (
    <div className="bg-text-2 h-[27.5rem] mt-[8.75rem] pt-[5rem] pb-[1.5rem]">
      <div className="relative grid grid-cols-12 container">
        <OnTop />

        <div className="md:col-span-6 lg:col-span-3 min-w-[13.5625rem] flex flex-col items-start gap-[1rem]">
          <div className="flex flex-col items-start gap-[1.5rem]">
            <span className="text-text-1 font-inter text-[1.5rem] font-[700] leading-[1.5rem] tracking-[0.045rem]">
              Exclusive
            </span>

            <span className="text-text-1 font-poppins text-[1.25rem] font-[500] leading-[1.75rem]">
              Subscribe
            </span>
        ...
        <div className="md:col-span-6 lg:col-span-3 min-w-[10.9375rem] flex flex-col items-start gap-[1.5rem]">
          <span className="text-text-1 font-poppins text-[1.25rem] font-[500] leading-[1.75rem]">
            Support
          </span>
        ...
        <div className="md:col-span-6 lg:col-span-2 min-w-[7.6875rem] flex flex-col items-start gap-[1.5rem]">
          <span className="text-text-1 font-poppins text-[1.25rem] font-[500] leading-[1.75rem]">
            Account
          </span>
        ...
        <div className="md:col-span-6 lg:col-span-2 min-w-[6.8125rem] flex flex-col items-start gap-[1.5rem]">
          <span className="text-text-1 font-poppins text-[1.25rem] font-[500] leading-[1.75rem]">
            Quick Link
          </span>
        ...
        <div className="md:col-span-6 lg:col-span-2 min-w-[12.375rem] flex flex-col items-start gap-[1.5rem]">
          <span className="text-text-1 font-poppins text-[1.25rem] font-[500] leading-[1.75rem]">
            Download App
          </span>
